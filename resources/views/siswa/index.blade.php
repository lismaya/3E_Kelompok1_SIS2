			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        <form action="/siswa/create" method="POST" enctype="multipart/form-data">
			        	{{csrf_field()}}
				  <div class="form-group{{$errors->has('nama_depan') ? 'has_error' : ''}}">
				  ...
				  <div class="form-group {{$errors->has('nama_belakang') ? 'has_error' : ''}}">
				  ...
				  <div class="form-group {{$errors->has('jenis_kelamin') ? 'has_error' : ''}}">
				  ...
				  <div class="form-group {{$errors->has('agama') ? 'has_error' : ''}}">
				  ...
				  <div class="form-group {{$errors->has('alamat') ? 'has_error' : ''}}">
				  	<label for="exampleFormControlTextarea1">Alamat</label>
				  	<textarea name="alamat" class="form-control" id="exampleFormControlTextarea1"rows="3">{{old('alamat')}}</textarea>
				  </div>

				  <div class="form-group {{$errors->has('avatar') ? 'has_error' : ''}}">
